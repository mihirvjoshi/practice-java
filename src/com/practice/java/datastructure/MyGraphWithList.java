...
public class MyGraphWithList {
	...
	public static void main(String args[]) {
		MyGraphWithList graph = new MyGraphWithList();
		graph.addEdges(0, 1);
		graph.addEdges(0, 4);
		graph.addEdges(1, 2);
		graph.addEdges(1, 3);
		...
		MyGraphWithList graph2 = new MyGraphWithList();
		graph2.addEdges(1, 2);
		graph2.addEdges(2, 3);
		graph2.addEdges(3, 4);
		graph2.addEdges(4, 1);
	...
	class Node {
		...
		private MyGraphWithList getOuterType() {
			return MyGraphWithList.this;
		}
	}

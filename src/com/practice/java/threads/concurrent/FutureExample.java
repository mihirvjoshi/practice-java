...
/** * Simple Java program to demonstrate how to use Callable and Future class in * Java. You can use FutureTask for asynchronous processing. * * @author WINDOWS 8 * */ 
public class FutureExample {
	public static void main(String... args) throws InterruptedException,
		...
		Future result10 = es.submit(new FutureExample().new FactorialCalculator(10));
		
		System.out.println("submitted callable task to calculate factorial of 15");
		Future result15 = es.submit(new FutureExample().new FactorialCalculator(15));
		
		System.out.println("submitted callable task to calculate factorial of 20");
		Future result20 = es.submit(new FutureExample().new FactorialCalculator(20));
	...
	private class FactorialCalculator implements Callable<Long> {
		private int number;

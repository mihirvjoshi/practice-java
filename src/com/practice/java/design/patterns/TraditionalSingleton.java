...
public class TraditionalSingleton {
	...
	// while you check null condition more than one thread can see null value
	// and try to create new instance 
	synchronized (TraditionalSingleton.class) {
	    if(instance == null)
		instance = new TraditionalSingleton(); //to avoid this initialize instance at the beginning instead null static value
	}
	return instance;		
    }
